...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset', type=str, default='PUNet-Normals')
    ...
    parser.add_argument('--stdze_loss', type=eval, default=False, choices=[True, False])
    parser.add_argument('--repulsion', type=int, default=0.05)
