...
class FullPFN(nn.Module):

    def __init__(self, straightpfn=None, args=None):
        super().__init__()
        self.args = args
        # geometry
        ...
        # networks
        if straightpfn is not None:
            self.velocity_nets = straightpfn.velocity_nets
            ...
            for i in range(self.num_modules):
                self.velocity_nets.append(DirectionNet(args=straight_ckpt['args']).to(args.device))
