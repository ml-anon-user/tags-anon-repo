...
def make_patches_for_pcl_pair(pcl_A, pcl_B, pcl_clean_normals, patch_size, num_patches, ratio):
    """
    Args:
    ...
    if pcl_clean_normals is not None:
        pat_normals_B = pcl_clean_normals[idx_B]
        return pat_A, pat_B, pat_normals_B, seed_pnts, seed_idx
    else:
        return pat_A, pat_B, seed_pnts, seed_idx
    

class PairedPatchWithNormalsDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        if self.split == 'train':
            pat_noisy, pat_clean, pat_clean_normals, seed_pts, seed_idx = make_patches_for_pcl_pair(
                    pcl_data['pcl_noisy'],
                    pcl_data['pcl_clean'],
                    pcl_data['pcl_clean_normals'],
            ...
            data = {
                ...
                'pcl_clean_normals': pat_clean_normals[0],
