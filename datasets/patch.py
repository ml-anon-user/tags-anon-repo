...
def make_patches_for_pcl_pair(pcl_A, pcl_A_L1, pcl_A_L2, pcl_B, patch_size, num_patches, ratio, train_straight_network, tot_its=None):
    """
    Args:
...
class PairedPatchDataset(Dataset):
    ...
    def __init__(self, datasets, patch_ratio, train_straight_network=False, tot_its=10, patch_size=1000, num_patches=1000, transform=None):
        super().__init__()
        ...
        self.train_straight_network = train_straight_network
    ...
    def __getitem__(self, idx):
        ...
        if not self.train_straight_network:
            pat_noisy_L2, pat_clean, pat_noisy = make_patches_for_pcl_pair(
                ...
                train_straight_network=self.train_straight_network
            )
            data = {
